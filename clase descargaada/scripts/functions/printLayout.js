...
const logoOffline = "data:image/png;base64,";

const loginData = JSON.parse(localStorage.getItem('login') || '[]');
const miCarrito = document.getElementById("cart");
console.log(miCarrito);

function mostrarCarrito() {
  if (miCarrito) {
    if (loginData) {
      miCarrito.style.display = "block"; // Mostrar la imagen
    } else {
      miCarrito.style.display = "none"; // Ocultar la imagen
    }
  } else {
    console.error("El elemento con ID 'mostrar-carrito' no se encontró.");
  }
}
mostrarCarrito()
